...
public class ProjectDAO extends BaseDAO<Project> {
    ...
    public List<ProjectsWithEmployeesDTO> findProjectsWithEmployeesSalariesHours(long numberOfEmployees,
        ...
        return switch (option) {
            case "all" ->
                    entityManager.createNamedQuery(Project.FIND_PROJECTS_WITH_EMPLOYEES_SALARIES, ProjectsWithEmployeesDTO.class)
                            .setParameter("numberOfEmployees", numberOfEmployees)
                            .setParameter("totalHours", totalHours)
                            .setParameter("totalSalaries", totalSalaries)
                            .getResultList();
            case "in" ->
                    entityManager.createNamedQuery(Project.FIND_PROJECTS_WITH_EMPLOYEES_SALARIES_IN_IDS, ProjectsWithEmployeesDTO.class)
                            .setParameter("numberOfEmployees", numberOfEmployees)
                            .setParameter("totalHours", totalHours)
                            .setParameter("totalSalaries", totalSalaries)
                            ...
                            .getResultList();
            case "notIn" ->
                    entityManager.createNamedQuery(Project.FIND_PROJECTS_WITH_EMPLOYEES_SALARIES_NOT_IN_IDS, ProjectsWithEmployeesDTO.class)
                            .setParameter("numberOfEmployees", numberOfEmployees)
                            .setParameter("totalHours", totalHours)
                            .setParameter("totalSalaries", totalSalaries)
                            .setParameter("projectIds", projectIds)
